...
const RealSimulationPage = () => {
  ...
  const {
    ...
    loaderUrl: 'RealBuild/RealBuild.loader.js',
    dataUrl: 'RealBuild/RealBuild.data.unityweb',
    frameworkUrl: 'RealBuild/RealBuild.framework.js.unityweb',
    codeUrl: 'RealBuild/RealBuild.wasm.unityweb',
  });
...
export default RealSimulationPage;
